...
static constexpr auto qt_meta_stringdata_CLASSMazeENDCLASS = QtMocHelpers::stringData(
    "Maze",
    "mazeLoaded",
    ""
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMazeENDCLASS_t qt_meta_stringdata_CLASSMazeENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 10),  // "mazeLoaded"
        QT_MOC_LITERAL(16, 0)   // ""
    },
    "Maze",
    "mazeLoaded",
...
void Maze::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Maze::*)();
            if (_t _q_method = &Maze::mazeLoaded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
